            ...
            <div class="grid items-center grid-cols-1 gap-12 lg:grid-cols-2">
              <div>
                <h1 class="text-4xl font-bold text-black sm:text-6xl lg:text-7xl">
                  The Knowledge Domain is Evolving, with
                  <div class="relative inline-flex">
                    <span class="absolute inset-x-0 bottom-0 border-b-[30px] border-blue-300"></span>
                ...
                <p class="mt-8 text-base text-black sm:text-xl">
                  Swift. Sharp. Sustainable. Begin Your Skill Boost Today with
                  Outgroww.
                </p>
